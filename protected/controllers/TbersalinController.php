...
class TbersalinController extends Controller {
...
// $this->performAjaxValidation($model);
        ...
        if (isset($_POST['Tbersalin'])) {
            $model->attributes = $_POST['Tbersalin'];
            if ($model->save())
                $this->redirect(array('view', 'id' => $model->id_bersalin));
        }
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('Tbersalin');
    ...
    public function actionAdmin() {
        $model = new Tbersalin('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Tbersalin']))
            $model->attributes = $_GET['Tbersalin'];
    ...
    public function loadModel($id) {
        $model = Tbersalin::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'tbersalin-form') {
